...
SKILLS = [
    ...
    {"name": "set_clipboard", "desc": "put text on the clipboard",
     "phrases": ["copy this to my clipboard", "put \"hello\" on the clipboard",
                 ...
                 "copy \"some words\" to the clipboard", "copy hello world to my clipboard",
                 "put my email on the clipboard", "copy that to the clipboard for me",
                 "set the clipboard to my address", "copy 1234 to my clipboard"],
     "run": set_clipboard},
